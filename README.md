...
[N8N Creator](https://n8n.io/creators/intuz/) · [Agentic AI Solution Development](https://www.intuz.com/ai-agents-for-business-automation/) · [AI Consulting Company](https://www.intuz.com/company/) · [For Custom Workflow Automation](https://www.intuz.com/get-started/)
...
Yes — this is the multi-repo variant. Add the same n8n webhook URL to each GitHub repository you want to automate. Intuz also offers a [single-repository version](https://github.com/Intuz-production/Automate-GitHub-PRs-Jira-Updates-from-Git-Commits) if you only need one repo.
